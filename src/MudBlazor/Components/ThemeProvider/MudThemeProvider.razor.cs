...
partial class MudThemeProvider : ComponentBaseWithState, IAsyncDisposable
{
    ...
    protected virtual void GenerateTheme(StringBuilder themeStringBuilder)
    {
        ...
        themeStringBuilder.AppendLine($"--{Palette}-properties-drawer-background: {palette.PropertiesDrawerBackground};");
        themeStringBuilder.AppendLine($"--{Palette}-dialog-bg: {palette.DialogBackground};");
		...
		themeStringBuilder.AppendLine($"--{Typography}-default-optical-sizing: {theme.Typography.Default.OpticalSizing};");
        ...
        themeStringBuilder.AppendLine($"--{Typography}-h1-optical-sizing: {theme.Typography.H1.OpticalSizing};");
        ...
        themeStringBuilder.AppendLine($"--{Typography}-h2-optical-sizing: {theme.Typography.H2.OpticalSizing};");
        ...
        themeStringBuilder.AppendLine($"--{Typography}-h3-optical-sizing: {theme.Typography.H3.OpticalSizing};");
        ...
        themeStringBuilder.AppendLine($"--{Typography}-h4-optical-sizing: {theme.Typography.H4.OpticalSizing};");
        ...
        themeStringBuilder.AppendLine($"--{Typography}-h5-optical-sizing: {theme.Typography.H5.OpticalSizing};");
        ...
        themeStringBuilder.AppendLine($"--{Typography}-h6-optical-sizing: {theme.Typography.H6.OpticalSizing};");
		...
		themeStringBuilder.AppendLine($"--{Typography}-subtitle1-optical-sizing: {theme.Typography.Subtitle1.OpticalSizing};");
		...
		themeStringBuilder.AppendLine($"--{Typography}-subtitle2-optical-sizing: {theme.Typography.Subtitle2.OpticalSizing};");
        ...
        themeStringBuilder.AppendLine($"--{Typography}-body1-optical-sizing: {theme.Typography.Body1.OpticalSizing};");
        ...
        themeStringBuilder.AppendLine($"--{Typography}-body2-optical-sizing: {theme.Typography.Body2.OpticalSizing};");
        ...
        themeStringBuilder.AppendLine($"--{Typography}-button-optical-sizing: {theme.Typography.Button.OpticalSizing};");
        ...
        themeStringBuilder.AppendLine($"--{Typography}-caption-optical-sizing: {theme.Typography.Caption.OpticalSizing};");
        ...
        themeStringBuilder.AppendLine($"--{Typography}-overline-optical-sizing: {theme.Typography.Overline.OpticalSizing};");
